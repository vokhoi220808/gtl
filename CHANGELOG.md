# 14.4.0-enterprise-trust-suite

- Added v14 Enterprise Trust Suite public page.
- Added printable Trust Certificate page.
- Added public portal/search/badge/printable-certificate API actions.
- Added runtime Asset Guard with CSS fallback for stale Service Worker/cache issues.
- Added API rate limit env vars and diagnostics checks.
- Added predeploy checker script.
- Bumped Service Worker/app cache keys to 14.4.0-enterprise-trust-suite.
- Preserved v12 API actions and existing PDF workflow.
