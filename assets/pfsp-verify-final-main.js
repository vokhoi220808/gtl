/* PDF Fusion Smart Pro - Verify System v14 app status strip */
(function(){
  'use strict';
  ...
  function inject(){
    ...
    div.innerHTML = `<div class="pfsp-final-head"><div class="pfsp-final-title"><div class="pfsp-final-badge">⚙️</div><div><h3>Deployment Check v14</h3><p>Kiểm tra nhanh API, signing secret, GitHub registry, allowlist, integrity, Trust Portal, batch verify và diagnostics trước khi phát hành production.</p></div></div><div class="pfsp-final-actions" style="margin-top:0"><button id="pfspV12Health" class="primary" type="button">Health</button><button id="pfspV12Self" type="button">Self-test</button><a href="./trust-portal.html" target="_blank" rel="noopener">Trust Portal</a><a href="./verify.html" target="_blank" rel="noopener">Verify Page</a><a href="./admin-verify.html" target="_blank" rel="noopener">Admin</a></div></div><div id="pfspV12HealthBox" class="pfsp-v11-result warn"><div class="pfsp-v11-verdict">Chưa kiểm tra</div><div class="pfsp-v11-message">Bấm Health sau khi deploy Vercel.</div></div>`;
