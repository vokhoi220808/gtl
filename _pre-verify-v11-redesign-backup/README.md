...
Bản cuối của hệ thống Verify: short QR, auto-register, server-signed certificate, registry audit log, revoke/restore/expiry, backup, integrity checker và `admin-verify.html`. Xem `UPGRADE_VERIFY_SYSTEM_FINAL_BIG_REPORT.md`.
