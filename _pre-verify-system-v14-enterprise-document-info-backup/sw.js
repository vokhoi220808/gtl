const VERSION = '13.0.0-trust-portal';
...
const APP_SHELL = [
  ...
  './assets/pfsp-admin-verify.js?v=13.0.0-trust-portal',
  './assets/pfsp-verify-final-page.js?v=13.0.0-trust-portal',
  './assets/pfsp-verify-final-main.js?v=13.0.0-trust-portal',
  './assets/pfsp-verify-final.css?v=13.0.0-trust-portal',
  './assets/pfsp-verify-asset-guard.js?v=13.0.0-trust-portal',
  './assets/pfsp-trust-portal.js?v=13.0.0-trust-portal',
  './assets/pfsp-trust-certificate.js?v=13.0.0-trust-portal',
  './admin-verify.html',
  './404.html',
  ...
  './assets/pfsp-document-hash-verify.js?v=13.0.0-trust-portal',
  './assets/pfsp-trusted-verify-registry.js?v=13.0.0-trust-portal',
...
function shouldCache(request, response) {
  try { if (new URL(request.url).pathname.startsWith('/api/')) return false; } catch {}
