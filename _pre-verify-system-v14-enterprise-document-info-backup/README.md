...
- Service Worker cache version `13.0.0-trust-portal`.
...
trust-portal.html           Public Trust Portal v13
...
Phần dưới là ghi chú legacy của bản v12 trước khi nâng lên v13. Bản hiện tại là `13.0.0-trust-portal`, vẫn giữ các chức năng v12 và thêm Trust Portal.
