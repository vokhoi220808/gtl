const VERSION = '12.1.1-ui-hotfix';
...
const APP_SHELL = [
  ...
  './assets/pfsp-admin-verify.js?v=12.1.1-ui-hotfix',
  './assets/pfsp-verify-final-page.js?v=12.1.1-ui-hotfix',
  './assets/pfsp-verify-final-main.js?v=12.1.1-ui-hotfix',
  './assets/pfsp-verify-final.css?v=12.1.1-ui-hotfix',
  './admin-verify.html',
  './404.html',
  ...
  './assets/pfsp-document-hash-verify.js?v=12.1.1-ui-hotfix',
  './assets/pfsp-trusted-verify-registry.js?v=12.1.1-ui-hotfix',
