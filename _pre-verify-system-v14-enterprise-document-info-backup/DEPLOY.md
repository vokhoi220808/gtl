# Deploy PDF Fusion Smart Pro with Verify System v13 Trust Portal
...
git init
git add .
git commit -m "Upgrade Verify System v13 trust portal"
git branch -M main
...
## Verify System v13 Trust Portal deploy checklist
...
Env vars bổ sung/khuyên dùng cho v13:
...
Nếu UI rơi về HTML thô, bản v13 có Asset Guard tự inject fallback CSS. Tuy vậy vẫn nên vào DevTools → Application → Service Workers → Unregister rồi reload một lần nếu trình duyệt giữ cache quá cũ.
